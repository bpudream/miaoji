...
export const UploadPage = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">上传音视频</h2>

      <div
        className={clsx(
          "border-2 border-dashed rounded-2xl p-12 text-center transition-all min-h-[400px] flex flex-col justify-center items-center",
